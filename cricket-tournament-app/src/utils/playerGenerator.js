...
import { generateUniqueId, getRandomElement } from './helpers';
...
export const updateTournamentSchedule = (matches, format = 'league') => {
  ...
  const completedMatches = updatedMatches.filter(match => 
    match.status === 'completed' && match.result?.winnerId
  );
      ...
      if (dependentMatches.length === match.dependsOn.length) {
        ...
        if (match.round === 'semifinal') {
          ...
          if (match.matchNumber === 1) {
            ...
            if (winner1 && winner2) {
              match.team1 = {
                id: winner1.result.winnerId,
                name: winner1.result.winnerId === winner1.team1.id ? winner1.team1.name : winner1.team2.name,
                color: winner1.result.winnerId === winner1.team1.id ? winner1.team1.color : winner1.team2.color
              };
              
              match.team2 = {
                id: winner2.result.winnerId,
                name: winner2.result.winnerId === winner2.team1.id ? winner2.team1.name : winner2.team2.name,
                color: winner2.result.winnerId === winner2.team1.id ? winner2.team1.color : winner2.team2.color
              };
            }
          }
          // Second semifinal gets winners from second two quarterfinals
            ...
            if (winner3 && winner4) {
              match.team1 = {
                id: winner3.result.winnerId,
                name: winner3.result.winnerId === winner3.team1.id ? winner3.team1.name : winner3.team2.name,
                color: winner3.result.winnerId === winner3.team1.id ? winner3.team1.color : winner3.team2.color
              };
              
              match.team2 = {
                id: winner4.result.winnerId,
                name: winner4.result.winnerId === winner4.team1.id ? winner4.team1.name : winner4.team2.name,
                color: winner4.result.winnerId === winner4.team1.id ? winner4.team1.color : winner4.team2.color
              };
            }
          }
        }
